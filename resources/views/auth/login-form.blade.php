<form method="POST" action="{{ route('login') }}">
    ...
    <div class="form-group ">
        ...
        <div class="">
            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"  name="email" value="{{ Cookie::has('frontuser') ? Cookie::get('frontuser') : old('email') }}" autocomplete="email" autofocus>
            @error('email')
    ...
    <div class="form-group">
        ...
        <div class="">
            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror"  name="password" autocomplete="current-password" value="{{ Cookie::has('frontpwd') ? Cookie::get('frontpwd') : '' }}">
            @error('password')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
    ...
    <div class="form-group">
        <div class="">
            <input type="checkbox" id="remember" name="remember" {{ Cookie::has('frontuser') ? 'checked' : '' }}>
			<label for="remember" class="col-form-label">{{ __('Remember Me') }}</label>
        </div>
    </div>
